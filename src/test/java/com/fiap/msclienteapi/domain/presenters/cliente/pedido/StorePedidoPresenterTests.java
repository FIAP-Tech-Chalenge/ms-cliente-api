...
public class StorePedidoPresenterTests {
    
    @Mock
    CriaPedidoOutput criaPedidoOutput;
    
    StorePedidoPresenter storePedidoPresenter;
    ...
    public void setUp() {
        ...
        storePedidoPresenter = new StorePedidoPresenter(criaPedidoOutput);
    }
    ...
    public void deveObterUmOutput() {
        ...
        when(criaPedidoOutput.getPedido()).thenReturn(pedido);

        var pedidoRetornado = storePedidoPresenter.getOutput().getPedido();
    ...
    void deveRetornarUmArray() {
        ...
        var pedidoRetornado = storePedidoPresenter.toArray();
